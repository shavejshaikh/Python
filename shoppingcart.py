...
if count==5:
    ...
    while a!=6: 
                ...
                if a==1:
                            ...
                            print("\n**************************************************")
                            print("\nWelcome to Mobile:")
                            m1=dict([(38000,'One plus 5T'),(88000,'i-phone x'),(40000,'Sumsung Galaxy egde')])
                            print(m1)
                            ...
                            t1=dict([(22000,'T.V'),(15000,'Washing Machine'),(28000,'A.C')])
                            print(t1)
                            ...
                            print("\n**************************************************")
                            print("\nWelcome to Offer:")
                            t1=dict([(40000,'T.V,A.C'),(95000,'i-phone x,One plus 5T'),(45000,'Laptop,Tablets')])
                            print(t1)
